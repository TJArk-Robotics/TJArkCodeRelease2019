...
public:
    ...
    /**< Special value that indicates that the joint is turned off. */ // TODO replace with constexpr
    enum
    {
        ignore = 20000
    };
    /**< Special angle for not overwriting the previous setting. */ // TODO replace with constexpr
    JointAngles();
...
public:
    std::array<Angle, Joints::NumOfJoint> angles; /**< The angles of all joints. */
