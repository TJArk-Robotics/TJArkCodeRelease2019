...
void ForwardKinematic::calculateArmChain(Arms::Arm arm, const JointAngles& joints, const RobotDimensions& robotDimensions, std::array<Pose3f, Limbs::NumOfLimb>& limbs)
{
...
void ForwardKinematic::calculateLegChain(Legs::Leg leg, const JointAngles& joints, const RobotDimensions& robotDimensions, std::array<Pose3f, Limbs::NumOfLimb>& limbs)
{
...
void ForwardKinematic::calculateHeadChain(const JointAngles& joints, const RobotDimensions& robotDimensions, std::array<Pose3f, Limbs::NumOfLimb>& limbs)
{
