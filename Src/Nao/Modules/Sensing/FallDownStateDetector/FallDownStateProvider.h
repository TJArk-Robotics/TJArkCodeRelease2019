...
class FallDownStateProviderBase
{
public:
    /** REQUIRES */
    ...
    Angle maxGyroToRegainStableState = 10_deg;
    Angle maxVelForPrediction = 100_deg;
    bool useInertiaData = false;
    bool playSounds = true;
    float velocityDiscountFactor = 0.9f;
    float forwardingTime = 0.1f;
    float minNormalizedFallVectorScalar = 0.5f;
    float minFallVectorScalar = 0.65f;
    float minPredictNormalizedFallVectorScalar = 0.91f;
    float minPredictFallVectorScalar = 1.1f;
    float minComDistanceToFootCenter = 10.f;
    float minComDistanceToDetetctFall = 110.f;
    float maxTorsoHeightToKeepSquatting = 225.f;
    float minTorsoHeightToKeepUpright = 210.f;
    float sigmaArea = 3.f;
    float maxFootHeightDiff = 80.f;
    int minTimeBetweenSound = 150;
    int minTimeWithoutGroundContactToAssumePickup = 0;

    Vector2a minTorsoOrientationToDetermineDirection = Vector2a(55_deg, 55_deg);
    Vector3f positionProcessDeviation = Vector3f(16.f, 16.f, 16.f);    //  dynamic noise density of the com-position
    Vector2a velocityProcessDeviation = Vector2a::Constant(22_deg);    // dynamic noise density of the velocity
    Vector3f positionMeasurementDeviation = Vector3f(2.f, 2.f, 2.f);   // measure noise of the com position
    Vector2a velocityMeasurementDeviation = Vector2a::Constant(3_deg); // measure noise of the gyro
};
